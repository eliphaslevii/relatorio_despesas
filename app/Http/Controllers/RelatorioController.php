...
class RelatorioController extends Controller
{
    ...
    public function rdv_ext_post(Request $request)
    {
        ...
        $valor_total_ext = $request->input('valor_total_ext');
                ...
                DB::table('ext_post')
                    ->insert(['nome_ext'=>$nome_ext,'cc_ext'=>$cc_ext,'data_input_ext'=>$data_input_ext,'semana_mes_ext'=>$semana_mes
                    ,'status'=>$status,'valor_total_ext'=>$valor_total_ext]);
