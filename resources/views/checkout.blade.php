...
<div class="container-fluid">
        <div class="row">
            <div class="col s12 m12">
                <div class="fd-panel mgtop">
                    ...
                    <form method="GET" action="{{url('/checkout_post')}}" id="content">
                    <div class="fd-panel__body content" >
                                ...
                                <div class="fd-form__set">
                                    ...
                                    <script>
                                        $(document).ready(function(){
                                            ...
                                            var last_part1 = parts[parts.length-1].length;

                                            if(last_part1 >= 3)
                                            {
                                                $('#oldvalue_1').html('Selecione a semana')
                                                $('#semana_mes_ext_1').val(last_part)
                                            }
                                            else
                                            {
                                                $('#oldvalue_1').html(last_part)
                                                $('#semana_mes_ext_1').val(last_part)
                                            }
                                        })
                                        $(document).ready(function(){
                                    ...
                                    <div class="fd-form__item">
                                        <select class="fd-form__control" id="nome_funcionario" name="nome_funcionario">
                                            <option >Selecione o funcioário!</option>
                                                    @foreach($funcionario as $s)
                                                   <option value="{{$s->nome_funcionario}}">{{$s->nome_funcionario}}</option>
                                                    @endforeach
                                                </select>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            <div class="col s4 m4">
                                <p class="fd-has-type-1" style="font-size: 20px" id="nome_ext_p">Nome:</p>
                            <input hidden name="nome_ext_1" id="nome_ext_1">
                            <input id="semana_mes_ext_1" hidden name="semana_mes_ext">
                            </div>
                            ...
                            <div class="col s4 m4">
                                @foreach($cc as $c)
                                <p class="fd-has-type-1" id="">Centro de custo: {{$c->conta_contabil}}</p>
                            <input hidden value="{{$c->conta_contabil}}" name="cc_ext" id="cc_ext">
                            @endforeach
                            </div>
                            ...
                            <script>
                                $(document).ready(function () {
                                  $('#nome_funcionario').change(function () {
                                      window.location = 'http://127.0.0.1:8000/checkout/' +$(this).val();

                                  })

                                  $('#semana_mes').change(function () {
                                      window.location = 'http://127.0.0.1:8000/checkout/' +'{{$nome_funcionario}}/'+ $(this).val();
                                  })
        ...
        <form method="GET" action="{{url('/ext_post_checkout')}}" id="former">
        <div class="row content">
            <div class="col s12 m12">
                <div class="fd-panel mgtop">
                    ...
                    <div class="fd-panel__body content" id="content1">
                        <table class="fd-table">
                            ...
                            <tbody>
                                ...
                                <td hidden><input hidden id="id{{$i}}" value="{{$d->id}}" name="id[]"></td>
                                <td>{{$d->data_cupom}}</td>
                                <td>{{$d->dia_semana}}</td>
                                ...
                                <td>
                                    <legend class="fd-form__legend" id="aprovado{{$i}}"></legend>
                                <div class="fd-form__item fd-form__item--check ">
                                    <label class="fd-form__label" for="status">
                                    </label>
                                        <input type="checkbox" class="fd-form__control classetxt" id="statuss{{$i}}" name=status[]>
                                </div>
                                </td>
                                <input hidden id="status{{$i}}" name="status[]" value="1">
                                <script>

                                    $('#statuss'+{{$i}}+'').on('change', function(){
                                        this.value = this.checked ? 99 : 0;
                                        if(this.value === '99')
                                        {
                                             $('#status'+{{$i}}+'').val('99');
                                            $('#aprovado'+{{$i}}+'').text('Aprovado');
                                        }

                                        else if(this.value === '0')
                                        {
                                            $('#status'+{{$i}}+'').val('1');
                                            $('#aprovado'+{{$i}}+'').text('Em análise');
                    ...
                    <div class="fd-panel__footer">
                        <button type="submit" class="fd-button right">Enviar</button>
                    </div>
                </div>
            </div>
        </div>
